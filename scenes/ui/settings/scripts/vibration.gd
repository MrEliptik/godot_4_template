...
func reflect_settings() -> void:
	var value: int = SettingsManager.settings[SettingsManager.CATEGORY.GAMEPLAY][SettingsManager.SETTING.VIBRATION]
	value_lbl.text = SettingsManager.strength_to_str[value]
	h_slider.value = value

func _on_h_slider_value_changed(value: float) -> void:
	SettingsManager.settings[SettingsManager.CATEGORY.GAMEPLAY][SettingsManager.SETTING.VIBRATION] = int(value)
